    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Modal */}
          <motion.div
            className="relative w-full max-w-2xl modal-container bg-white dark:bg-surface-800 rounded-2xl shadow-2xl modal-flex-container overflow-hidden"
          ...
          >
            ...
            {/* Form */}
            <div className="flex-1 min-h-0 overflow-hidden modal-content-scroll">
              <EventForm
                event={event}
